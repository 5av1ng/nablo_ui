...
use crate::{layout::{Layout, LayoutId}, prelude::{Animatedf32, Color, FillMode, FontId, InputState, Painter, Rect, Vec2, Vec4}, App};
...
impl<S: Signal, A: App<Signal = S>> Radio<S, A> {
...
impl<S: Signal, A: App<Signal = S>> Widget for Radio<S, A> {
	type Signal = S;
	type Application = A;
